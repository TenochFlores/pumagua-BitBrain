    ...
    if "q" in request.GET:
        ...
        for coordenada in data:
            ...
            folium.Marker(
                ...
                + '" width="150px">',
                icon=folium.Icon(icon="glyphicon-remove-sign", color="red"),
            ).add_to(m)
    else:
        ...
        for coordenada in datosBebederos:
            ...
            if coordenada.estado == '0':
                icon_color = 'red'
            elif coordenada.estado == '1':
                icon_color = 'blue'
            elif coordenada.estado == '2':
                icon_color = 'orange'
                
            if coordenada.estado == '0':
                icon_shape = "glyphicon glyphicon-remove-sign"
            elif coordenada.estado == '2':
                icon_shape = "glyphicon glyphicon-wrench"
            else: 
                icon_shape = "glyphicon glyphicon-tint"
